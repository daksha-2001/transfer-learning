...
def main(config_path):
    ...
    new_model.add(tf.keras.layers.Dense(2,name="output_layer",activation="softmax"))
    new_model.summary()
    ...
    y_train_bin, y_test_bin, y_valid_bin = update_odd_even([y_train, y_test, y_valid])
